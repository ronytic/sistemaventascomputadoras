...
foreach($ventadetalle->mostrarTodos($where,"fecha") as $inv){$i++;
	...
	$cli=array_shift($cliente->mostrar($ven['codcliente']));
	...
	$pdf->CuadroCuerpo(20,($inv['precio']),1,"R",1);
	...
	$pdf->CuadroCuerpo(50,($cli['razonsocial']),0,"",1);
	$pdf->CuadroCuerpo(20,($cli['nitci']),0,"",1);
