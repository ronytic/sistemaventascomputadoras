...
$pro=todolista($producto->mostrarTodo("","nombre"),"codproducto","nombre,caracteristica,codigonserie","-");

include_once("../../class/proveedor.php");
$proveedor=new proveedor;
$prov=todolista($proveedor->mostrarTodo("","nombres"),"codproveedor","nombres,apellidos,razonsocial","-");
...
<div class="grid_12">
	<div class="contenido imagenfondo">
    	<div class="prefix_0 grid_4 alpha">
			<fieldset>
				...
				<table class="tablareg">
					...
					<tr>
						<td colspan="4"><?php campos("Producto","codproducto","select",$pro,1,array("required"=>"required"));?></td>
					</tr>
					<tr>
                    	...
                    	<td colspan="2"><?php campos("Precio Venta","precioventa","text","");?></td>
                    </tr>
                    <tr>
						<td colspan="2"><?php campos("Proveedor","codproveedor","select",$prov);?></td>
						<td colspan="2"><?php campos("Número de Factura","numerofactura","text","",0,array("size"=>30));?></td>
					</tr>
                    <tr>
						<td colspan="4"><?php campos("Observación","observacion","textarea","",0,array("rows"=>5,"cols"=>80));?></td>
					</tr>
