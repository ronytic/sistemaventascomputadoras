...
<option value="<?php echo $pr['codproducto']?>" rel="<?php echo $sumatotal;?>" rel-cantidad="<?php echo $sumatotal;?>"><?php echo $pr['nombre']." - ".$pr['codigonserie']?></option>
<?php }?>
</select></td>
...
<td><input type="number" name="pro[<?php echo $l?>][preciounitario]" value="0" min="0" size="5" maxlength="5" style="width:70px" class="preciounitario der" rel-linea="<?php echo $l?>" rel-preciounitario="<?php echo $l?>"></td>
