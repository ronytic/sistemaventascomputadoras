    	...
    	<div class="prefix_2 grid_4 alpha">
			<fieldset>
				...
				<table class="tablareg">
                    ...
                    <tr>
						<td colspan="2"><?php campos("Cliente","codcliente","select",$cli,0,array("required"=>"required"),$ven['codcliente']);?></td>	
					</tr>
                </table>
        	...
        	<fieldset>
                ...
                <table class="tablareg">
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="pro[<?php echo $l?>][preciounitario]" value="<?php echo $vd['precio']?>" min="0" size="5" maxlength="5" style="width:70px" class="preciounitario der" readonly></td>
                        <td><input type="text" name="pro[<?php echo $l?>][subtotal]" value="<?php echo $vd['total']?>" size="10" min="0" maxlength="10" style="width:100px" class="subtotal der" readonly ></td>
                    ...
                    Observación:<br>
                    <textarea name="observacionpago" cols="50" rows="4"><?php echo $ven['observacionpago']?></textarea><br>Garantia:<br>
                    <textarea name="garantia" cols="50" rows="4"><?php echo $ven['garantia']?></textarea>
                    ...
                    <input type="text" name="pagado" class="der pagado" value="<?php echo $ven['totalcancelado']?>"  size="10" style="width:100px" >
                    <input type="text" name="devolucion" class="der devolucion" value="<?php echo $ven['devolucion']?>" readonly size="10" style="width:100px"></td><td><?php campos("Fecha de Pago","fechapago","date",$ven['fechapago'],0,array("required"=>"required","style"=>"width:130px"));?><br><?php campos("Código","codigo","text",$ven['codigo'],0,array("size"=>"10"));?></td></tr>
