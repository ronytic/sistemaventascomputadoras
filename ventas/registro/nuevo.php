			...
			<fieldset>
				...
				<table class="tablareg">
                    ...
                    <tr>
                        ...
                        <td><?php campos("Cliente","codcliente","select",$cli,0,array("required"=>"required"));?></td>										
        ...
        <div class="prefix_0 grid_10 alpha">
        	<fieldset>
                ...
                <table class="tablareg">
                    ...
                    Observación:<br>
                    <textarea name="observacionpago" cols="50" rows="4"></textarea>
                    <br>Garantia:<br>
                    <textarea name="garantia" cols="50" rows="4"></textarea>
                    ...
                    <input type="text" name="devolucion" class="der devolucion" value="0" readonly size="10" style="width:100px"></td><td><?php campos("Fecha de Pago","fechapago","date",date("Y-m-d"),0,array("required"=>"required","style"=>"width:130px"));?><br><?php campos("Código","codigo","text","",0,array("size"=>"10"));?></td>	</tr>
